  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="rolesList" border stripe>
        ...
        <el-table-column label="操作" prop="roleDesc"  width="300">
          <template v-slot="scope">
    ...
    <el-dialog
      ...
      >
      <!--树形控件-->
      <el-tree :data="rightslist" :props="treeProps" ref="treeRef"  show-checkbox node-key="id" :default-expand-all="this.isExpandRightDialogTree" :default-checked-keys="defKeys"></el-tree>
...
export default {
  ...
  methods:{
    // 按钮展开树形结构
    // ExpandRightDialogTree(){
    //   this.isExpandRightDialogTree = !this.isExpandRightDialogTree
    //   console.log(this.isExpandRightDialogTree)
    // }
    handleClose(done) {
      this.$confirm('确认关闭？')
        .then(_ => {
